  ...
  public: {
    Tables: {
      ...
      share_komentar: {
        ...
        Relationships: [
          {
            foreignKeyName: "share_komentar_oleh_user_id_fkey"
      ...
      share_lampiran: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "share_lampiran_uploaded_by_fkey"
            columns: ["uploaded_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      share_paket: {
        ...
        Relationships: [
          {
            foreignKeyName: "share_paket_approver_id_fkey"
            columns: ["approver_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "share_paket_dataset_template_id_fkey"
            columns: ["dataset_template_id"]
            isOneToOne: false
            referencedRelation: "dataset_template"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "share_paket_pengirim_opd_id_fkey"
            columns: ["pengirim_opd_id"]
            isOneToOne: false
            referencedRelation: "opd"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "share_paket_pengirim_user_id_fkey"
            columns: ["pengirim_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          },
      ...
      share_riwayat: {
        ...
        Relationships: [
          {
            foreignKeyName: "share_riwayat_oleh_user_id_fkey"
            columns: ["oleh_user_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      share_target: {
        ...
        Relationships: [
          {
            foreignKeyName: "share_target_dibuka_oleh_fkey"
            columns: ["dibuka_oleh"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "share_target_target_opd_id_fkey"
          ...
          {
            foreignKeyName: "share_target_target_pejabat_id_fkey"
            columns: ["target_pejabat_id"]
            isOneToOne: false
            referencedRelation: "pejabat"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "share_target_target_user_id_fkey"
